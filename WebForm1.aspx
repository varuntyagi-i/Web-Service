...
<head runat="server">
    ...
    <script type="text/javascript" lang="javascipt">
        function GetDataById() {  
            ...
            WebServiceONGC.DataFetchService.GetDataById(id1, GetDataByIdSuccessCallback);//,GetDataByIdFailedCallback);
        }
        ...
        <table style="font-family: Arial; border: 1px solid black">
            <tr>
                ...
                <td>
                    ...
                    <input id="Button1" type="button" value="get value" onclick="GetDataById()" />
                </td>
            </tr>
        </table>

        <h3 style="background-color:red">To get to know information about FIELD_VIEW enter ID</h3>
